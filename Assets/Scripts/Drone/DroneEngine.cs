...
public class DroneEngine : MonoBehaviour, IEngine
{
    ...
    [SerializeField] private float propRotSpeed;
    #endregion
    ...
    public void UpdateEngine(Rigidbody rb, DroneInputs input)
    {
        ...
        engineForce = transform.up * ((rb.mass * Physics.gravity.magnitude + finalDiff) + (input.Throttle * (maxPower + PlayerPrefs.GetInt("EnginePower")))) / 4f;
