...
Shader "QFX/SFX/EnergyWall"
{
	Properties
	{
		...
		[Toggle]_BlendGrid("Blend Grid", Float) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float screenDepth2_g39 = LinearEyeDepth(UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture,UNITY_PROJ_COORD( ase_screenPos ))));
			float distanceDepth2_g39 = abs( ( screenDepth2_g39 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( _DepthDistance ) );
			float4 temp_output_36_0 = ( pow( saturate( ( 1.0 - distanceDepth2_g39 ) ) , _DepthFadeExp ) * _DepthColor );
			float3 ase_worldNormal = i.worldNormal;
			float3 temp_output_22_0_g40 = abs( ase_worldNormal );
			float3 ase_worldPos = i.worldPos;
			float2 appendResult8_g40 = (float2(ase_worldPos.y , ase_worldPos.z));
			float2 appendResult4_g40 = (float2(_GridTilling , _GridTilling));
			float2 appendResult9_g40 = (float2(_GridOffsetX , _GridOffsetY));
			float4 temp_cast_0 = (_GridTexturePow).xxxx;
			float2 appendResult7_g40 = (float2(ase_worldPos.z , ase_worldPos.x));
			float4 temp_cast_1 = (_GridTexturePow).xxxx;
			float2 appendResult6_g40 = (float2(ase_worldPos.x , ase_worldPos.y));
			float4 temp_cast_2 = (_GridTexturePow).xxxx;
			float3 weightedBlendVar27_g40 = ( temp_output_22_0_g40 * temp_output_22_0_g40 );
			float4 weightedAvg27_g40 = ( ( weightedBlendVar27_g40.x*pow( tex2D( _GridTexture, ( ( appendResult8_g40 * appendResult4_g40 ) + appendResult9_g40 ) ) , temp_cast_0 ) + weightedBlendVar27_g40.y*pow( tex2D( _GridTexture, ( ( appendResult7_g40 * appendResult4_g40 ) + appendResult9_g40 ) ) , temp_cast_1 ) + weightedBlendVar27_g40.z*pow( tex2D( _GridTexture, ( ( appendResult6_g40 * appendResult4_g40 ) + appendResult9_g40 ) ) , temp_cast_2 ) )/( weightedBlendVar27_g40.x + weightedBlendVar27_g40.y + weightedBlendVar27_g40.z ) );
			float4 temp_output_116_0 = weightedAvg27_g40;
			float4 temp_output_151_0 = ( _TintColor * temp_output_116_0 );
			float2 temp_cast_3 = (i.uv_texcoord.x).xx;
			float2 temp_cast_4 = (i.uv_texcoord.y).xx;
			#if defined(_MAINTEXNOISE_UV)
				float2 staticSwitch73 = i.uv_texcoord;
			#elif defined(_MAINTEXNOISE_U)
				float2 staticSwitch73 = temp_cast_3;
			...
			float temp_output_72_0_g10 = ( tex2D( _DistortionMap, (panner21_g10*_NoiseDistortionTilling + 0.0) ).r * _NoiseDistortionPower );
			float2 panner71_g10 = ( 1.0 * _Time.y * _NoiseSpeed + i.uv_texcoord);
			float spheremask176 = saturate( ( ( distance( i.uv_texcoord , _SphereCenter ) - _SphereRadius ) / saturate( _SphereHardness ) ) );
			float4 temp_output_22_0 = ( ( _TintColor * tex2D( _MainTex, ( ( _MainTexSpeed * _Time.y ) + ( _MainTextureTilling * ( staticSwitch73 + ( ( tex2D( _NoiseMap, ( temp_output_72_0_g10 + (panner71_g10*_NoiseTilling + 0.0) ) ).r * _NoisePower ) - _NoiseOffset ) ) ) ) ).r * spheremask176 ) + temp_output_36_0 );
			float2 panner21_g38 = ( 1.0 * _Time.y * _NoiseDistortionSpeed + i.uv_texcoord);
			float temp_output_72_0_g38 = ( tex2D( _DistortionMap, (panner21_g38*_NoiseDistortionTilling + 0.0) ).r * _NoiseDistortionPower );
			float2 panner71_g38 = ( 1.0 * _Time.y * _NoiseSpeed + i.uv_texcoord);
			float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( ase_screenPos );
			float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
			float4 screenColor19 = tex2D( _GrabTexture, ( ( ( tex2D( _NoiseMap, ( temp_output_72_0_g38 + (panner71_g38*_NoiseTilling + 0.0) ) ).r * _NoisePower ) - _NoiseOffset ) + ase_grabScreenPosNorm ).xy );
...
/*ASEBEGIN
Version=15600
137;330;1412;619;2259.183;-1238.839;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;58;-1792.69,499.6448;Float;False;QFX Get Simple Noise Distortion;10;;10;dba3a45ee088a1c42ae7fbf09d132e5e;0;0;4;COLOR;81;COLOR;82;FLOAT;64;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;73;-1824.69,291.6447;Float;False;Property;_MainTexNoise;Main Tex Noise;25;0;Create;True;0;0;False;0;0;0;0;True;;KeywordEnum;3;UV;U;V;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;63;-1824.69,195.6448;Float;False;Property;_MainTextureTilling;Main Texture Tilling;24;0;Create;True;0;0;False;0;0.1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;68;-1792.69,-124.3552;Float;False;Property;_MainTexSpeed;Main Tex Speed;23;0;Create;True;0;0;False;0;0.5,0;-0.5,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleAddOpNode;66;-1504.69,339.6447;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TimeNode;71;-1808.69,35.64485;Float;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;188;-2203.421,1496.055;Float;False;QFX Get UV Sphere;0;;36;d86a4ad3b71cd824c86058e21d8a1a56;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;67;-1360.69,291.6447;Float;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;176;-1973.55,1491.154;Float;True;spheremask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;69;-1184.69,147.6448;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;6;-944.6894,-140.3552;Float;False;Property;_TintColor;Tint Color;31;1;[HDR];Create;True;0;0;False;0;1,1,1,1;6,5.834484,0,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;174;-1746.125,1496.342;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;24;-1040.689,99.64478;Float;True;Property;_MainTex;Main Tex;26;0;Create;True;0;0;False;0;None;8ff96dbed3bc8ab44a7842f0bc5c934a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;116;-1271.634,763.707;Float;False;QFX Get Weight Blended Texture;4;;40;71af75d3d7ad4f045be3dfc5ea711f13;0;0;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;18;-2033.524,913.1259;Float;False;QFX Get Simple Noise Distortion;10;;38;dba3a45ee088a1c42ae7fbf09d132e5e;0;0;4;COLOR;81;COLOR;82;FLOAT;64;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;36;-1180.586,638.5232;Float;False;QFX Get Depth Fade Color;27;;39;178c752a5f1ef2644a24cb6a097a6938;0;0;1;COLOR;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;175;-1426.062,1490.645;Float;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;21;-1781.307,982.9654;Float;False;2;2;0;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;184;-1125.243,1467.516;Float;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;149;-168.2987,439.4539;Float;False;Property;_BlendGrid;Blend Grid;20;0;Create;True;0;0;False;0;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;28;242.7763,1634.742;Float;False;Property;_OpacityPower;Opacity Power;22;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;153;270.9916,1351.237;Float;False;Property;_NoiseDistortion;NoiseDistortion;21;0;Create;True;0;0;False;0;1;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;2;1009.879,853.4917;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;QFX/SFX/EnergyWall;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=9CE98212FAEE48AB7CE4FBB27AF6E9D3BFDBDA14