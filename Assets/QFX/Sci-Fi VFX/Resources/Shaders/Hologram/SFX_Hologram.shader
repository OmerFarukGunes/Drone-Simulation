...
Shader "QFX/SFX/Hologram/Hologram"
{
	Properties
	{
		...
		[Toggle]_GlowOpacity("Glow Opacity", Float) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 temp_cast_1 = (_Scan).xx;
			float2 Scan35 = step( frac( ( ( _ScanTiling * ase_worldPos.y ) + ( _Time.y * _ScanSpeed ) ) ) , temp_cast_1 );
			float4 Flicker72 = tex2D( _FlickerTexture, ( _Time.y * _FlickerSpeed ) );
			float4 Opacity149 = ( float4( lerp(( Scan35 + glow_val219 ),( Scan35 * glow_val219 ),_GlowOpacity), 0.0 , 0.0 ) * Flicker72 );
			o.Alpha = ( saturate( lerp(Opacity149,( Opacity149 * fresnel_val172 ),_FresnelOpacity) ) * _OpacityPower ).r;
		}
...
/*ASEBEGIN
Version=16500
7;166;1278;877;922.0614;-278.9424;2.442501;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-2522.948,1095.463;Float;False;Property;_GlowTiling;Glow Tiling;3;0;Create;True;0;0;False;0;2;0.9;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;68;-821.6207,715.4508;Float;True;Property;_FlickerTexture;Flicker Texture;9;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;241;330.3557,389.8206;Float;False;Property;_GlowOpacity;Glow Opacity;15;0;Create;True;0;0;False;0;0;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;73;327.664,522.4269;Float;False;72;Flicker;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;220;-339.8762,-84.12777;Float;False;QFX Get Fresnel;11;;8;0a832704e6daa5244b3db55d16dfb317;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;132;-254.7276,-346.4791;Float;False;Property;_EmissionColor;Emission Color;1;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1,0.2352938,0.2352938,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;131;-338.5438,-547.3767;Float;True;Property;_EmissionTexture;Emission Texture;2;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;209;-1405.988,1081.449;Float;False;Property;_GlowColor;Glow Color;4;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.3455879,0.5125756,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;166;-338.0693,-8.384624;Float;False;Property;_FresnelColor;Fresnel Color;14;1;[HDR];Create;True;0;0;False;0;1,1,1,1;2.123126,0.1102935,3.000003,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;173;454.9864,1346.248;Float;False;172;fresnel_val;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;150;525.5956,1204.333;Float;False;149;Opacity;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector3Node;155;-663.7959,1120.956;Float;False;Property;_GlitchOffset;Glitch Offset;17;0;Create;True;0;0;False;0;0,0,0;0.02,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;208;-695.6877,1294.305;Float;False;QFX Get Simple Glitch;20;;9;bb16914625242fb46ba2e0385c26d46a;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;170;662.3848,1327.509;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;176;444.4014,1117.257;Float;False;172;fresnel_val;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;171;800.5705,1204.74;Float;False;Property;_FresnelOpacity;Fresnel Opacity;16;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;941.9641,1342.734;Float;False;Property;_OpacityPower;Opacity Power;19;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;177;644.6245,1123.155;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;18;598.2053,991.6315;Float;False;8;fresnel_color;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;174;1033.673,1206.573;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;243;1220.964,1206.734;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;175;906.9359,971.3859;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;88;885.6175,1481.901;Float;False;87;VertexOffset;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;129;1459.892,1024.308;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;QFX/SFX/Hologram/Hologram;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;TransparentCutout;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;129;2;175;0
WireConnection;129;9;243;0
WireConnection;129;11;88;0
ASEEND*/
//CHKSM=81D1F0B601F240D029C1D5B89DB492113618BA37